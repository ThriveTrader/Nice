...
const Card = () => {
  return (
      <div class="relative flex h-full transform overflow-hidden items-end border-2 border-black rounded-xl bggg transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
        <div class="p-4 text-white !pt-0 mt-6  mb-6 ml-4 mr-4 mkk border rounded-xl border-white transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8">
        ...
        <div class="p-4 !pt-0 mt-6 text-white  mb-6 ml-4 mr-4 mkk border rounded-xl border-white transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8">
        ...
        <div class="p-4 !pt-0 mt-6 mb-6 ml-4 text-white mr-4 mkk border rounded-xl border-white transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8">
